...
interface PropsTypes {
	text: string;
	variant?: "primary" | "secondary" | "linear" | "next" | "text" | "redirection";
	onPress: any;
	disabled?: boolean;
	label?: string;
		...
		<View style={[styles.container, containerStyle]}>
			...
			>
				...
				{(variant === "next" || variant === "redirection") && !isLoading && (
					<Icon iconName="rightAngle" color={variant === "redirection" ? colors.textDark : ""} />
				)}
			</TouchableOpacity>
		</View>
	);
...
const styles = StyleSheet.create({
	...
	labelStyle: { fontSize: typography.sizes.s, fontWeight: "400", color: colors.textGray },
	...
	linearBtnText: { color: colors.textDark, fontSize: typography.sizes.base, fontWeight: "400" },
	textBtnText: {
		color: colors.main,
		backgroundColor: colors.bgGray,
	...
	redirectBtnText: { color: colors.textDark, fontSize: typography.sizes.base, fontWeight: "400" },
