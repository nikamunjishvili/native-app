...
import DashboardTabRoutes, { RootDashboardTabParamList } from "./DashboardTabRoutes";
...
export type DashboardStackScreensProps<t extends keyof RootStackParamList> = NativeStackScreenProps<
	RootStackParamList,
	t
>;
